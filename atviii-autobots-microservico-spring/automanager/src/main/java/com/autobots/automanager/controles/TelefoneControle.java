...
public class TelefoneControle {
	...
	public ResponseEntity<List<Telefone>> encontrarTelefones(){
	...
	public ResponseEntity<Telefone> encontrarTelefone(@PathVariable Long id){
	...
	@DeleteMapping("/deletar/{idTelefone}")
	public ResponseEntity<?> deletarTelefone(@PathVariable Long idTelefone){
